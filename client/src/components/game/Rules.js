  ...
  return (
    <Fragment>
      <div className='rules'>
        ...
        <p>
          Fight the Landlord is played with three players. The game uses a
          standard 54-card deck including the two jokers. Each player is
          initially dealt 17 cards, and three cards will remain in the middle.
        ...
        <p>
          ...
          the game. The first player to bid will be randomly chosen. On each
          player's turn to bid, that player may either pass or bid higher than
          the highest bid so far. If everyone passes before someone bids, the
          deck is reshuffled and redealt. If there is a bid, the bidding
        ...
        <p>
          The landlord plays first, and may play any legal combination of cards.
          Each subsequent player must either pass (play nothing) or beat the
          previous play by playing the same combination but with a higher rank.
          There are only two exceptions to this: rockets can beat any other
          combination, and bombs can beat any other combination except for a
          higher ranking bomb or a rocket. This play continues until two
          consecutive players pass, at which point the next player can now play
          any legal combination since he was the one that played the cards the
          other two players both passed on.
        </p>
        <p className='my-1'>
        ...
        <p className='my-1'>
          In Fight the Landlord, there are many different combinations of cards
          that can be played. Some examples of possible combinations include:{' '}
        </p>
        <ul>
          <li>
        ...
        <p>
          ...
          will have to pay him the bid value (some cash value) multiplied by the
          current bid (1, 2, or 3) provided that no bombs or rockets were
          played. If one of the peasants runs out of cards before the landlord,
          the landlord must pay the the bid value times the current bid to each
          peasant. For example, if a game has a bid value of $2000, the highest
          bid was a 2, and the landlord lost, the landlord will have to pay
          $4000 to each peasant. If the landlord won, each peasant will have to
          pay the landlord $4000. For each instance a bomb or rocket is played,
          the current bid is doubled. For example, if a rocket and two bombs are
          played in a game with a bid of 3, the bid is now 24. If the bid value
          of that game were $2000, the landlord could potentially lose $48,000
          or gain $48,000.
        </p>
        ...
        <p>
          In each game, public or private, there will be a total of 3 rounds
          played with each player being able to have first bid in one of the
          rounds. Each round will be played with the same rules as described
          above.
        </p>
        ...
        <p>
          ...
          only be able to play $500 games.
        </p>
      </div>
    </Fragment>
  );
